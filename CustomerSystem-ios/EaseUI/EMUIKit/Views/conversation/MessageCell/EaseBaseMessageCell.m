...
- (void)layoutSubviews
{
    ...
    switch (self.model.bodyType) {
        ...
        {
            if ([self.model.message.ext objectForKey:@"msgtype"] || [EaseBubbleView isTransferMessage:self.model.message] || [EaseBubbleView  isEvaluateMessage:self.model.message]) {
