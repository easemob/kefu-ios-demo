...
typedef void(^HDVECClickHideBlock)(UIButton *btn);
typedef void(^HDVECClickZoomBtnBlock)(UIButton *btn);
...
@property (nonatomic, copy) HDVECClickHideBlock clickHideBlock;
@property (nonatomic, copy) HDVECClickZoomBtnBlock clickZoomBtnBlock;
