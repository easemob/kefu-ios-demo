...
#import "HDVECCollectionViewCell.h"
#import "Masonry.h"

@interface HDVECCollectionViewCell ()
@property (nonatomic, strong) UILabel *nickNameLabel;
@property (nonatomic, strong) UIButton *muteBtn;

@property (nonatomic, strong) UIImageView *bgImgView;
@end
@implementation HDVECCollectionViewCell
...
- (void)setItem:(HDVECCollectionViewCellItem *)item {
    _item = item;
...
- (void) closeVideoAddView:(HDVECCollectionViewCellItem *)item{
...
- (UILabel *)nickNameLabel{
    if (!_nickNameLabel) {
        ...
        _nickNameLabel.backgroundColor = [[HDVECAppSkin mainSkin] contentColorBlockalpha:0.65];
...
//        _muteBtn.selected = YES;
        ...
        UIImage *img  = [UIImage imageWithIcon:kmaikefeng5 inFont:kfontName size:22 color:[[HDVECAppSkin mainSkin] contentColorBlue]  withbackgroundColor:[UIColor whiteColor] ] ;
...
//        UIImage *imgSel  = [UIImage imageWithIcon:kjinmai2 inFont:kfontName size:22 color:[[HDAppSkin mainSkin] contentColorRed] withbackgroundColor:[UIColor whiteColor]  ] ;
        UIImage *imgSel  = [UIImage imageWithIcon1:kjinmai inFont:kfontName size:22 color:[[HDVECAppSkin mainSkin] contentColorWhitealpha:1] withbackgroundColor:[[HDVECAppSkin mainSkin] contentColorRed]  ] ;
