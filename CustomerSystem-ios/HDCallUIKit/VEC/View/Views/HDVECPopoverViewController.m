...
//    titleLabel.backgroundColor = [UIColor yellowColor];
    ...
    if (item.isOn) {
        ...
        img.image = [UIImage imageWithIcon:item.imgName inFont:kfontName size:img.hd_size.width color:[[HDVECAppSkin mainSkin] contentColorRed] ] ;
    }else{
    img.image = [UIImage imageWithIcon:item.imgName inFont:kfontName size:img.hd_size.width color: [[HDVECAppSkin mainSkin] contentColorBlue] ] ;
    }
    [cell addSubview:img];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HDVECPopoverViewControllerCellItem * item =  [self.dataArray objectAtIndex:indexPath.row];
