...
- (HDVECDrawingBoardView *)hdDrawView{
    
    if (!_hdDrawView) {
        
        _hdDrawView = [[HDVECDrawingBoardView alloc] init];
    }
    return  _hdDrawView;
...
- (UIButton *)resignBtn{
    if (!_resignBtn) {
        ...
        //为button赋值
        [_resignBtn setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/vec_chexiao.png"] forState:UIControlStateNormal];
...
//        [_sureBtn setImage:[UIImage imageNamed:@"on.png"] forState:UIControlStateNormal];
        ...
        _sureBtn.backgroundColor = [[HDVECAppSkin mainSkin] contentColorBlueHX];
