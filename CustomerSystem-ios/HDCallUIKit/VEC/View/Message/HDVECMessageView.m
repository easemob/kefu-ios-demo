...
@implementation HDVECMessageView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        //添加背景色
        self.backgroundColor = [[HDVECAppSkin mainSkin] contentColorGrayWhithWite];
...
- (UILabel *)titleLabel{
    ...
    if (!_titleLabel) {
        ...
        _titleLabel.font =  [[HDVECAppSkin mainSkin] systemBoldFont16pt];
    }
