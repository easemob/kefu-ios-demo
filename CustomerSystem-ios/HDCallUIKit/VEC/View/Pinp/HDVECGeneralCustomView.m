 ...
 */
@implementation HDVECGeneralButton
...
@end
@implementation HDVECGeneralScrollView
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    [[self nextResponder]touchesBegan:touches withEvent:event];
}
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
...
@end
@implementation HDVECGeneralImageView
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    [[self nextResponder]touchesBegan:touches withEvent:event];
}
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
...
@end
@implementation HDVECGeneralView
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    [[self nextResponder]touchesBegan:touches withEvent:event];
}
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
...
@interface HDVECGeneralCustomView()<UIScrollViewDelegate>
{
    AVPlayer *_player;
...
@implementation HDVECGeneralCustomView
...
- (void)createCustomMusic{
    if (!_customContentView) {
        _customContentView=[[HDVECGeneralView alloc]init];
...
- (void)createCustomScrollView{
    if (!_customScrollView) {
        _customScrollView=[[HDVECGeneralScrollView alloc]init];
...
- (void)createCustomOtherView{
    if (!_customContentView) {
        ...
        _customContentView.backgroundColor= [[HDVECAppSkin mainSkin] contentColorGrayWhithWite];
        _customContentView.userInteractionEnabled=YES;
...
- (UIImageView *)iconImageView{
    ...
    if (!_iconImageView) {
        ...
        UIImage * img = [UIImage imageWithIcon:kdianhuatianchong inFont:kfontName size:32 color:[[HDVECAppSkin mainSkin] contentColorGreenWeb] ];
...
- (UILabel *)timeLabel{
    if (!_timeLabel) {
        ...
        _timeLabel.textColor =[[HDVECAppSkin mainSkin] contentColorGreenWeb];
