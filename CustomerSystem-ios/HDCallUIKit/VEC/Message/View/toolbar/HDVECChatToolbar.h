...
@protocol HDVECChatToolbarDelegate;
@interface HDVECChatToolbar : UIView
@property (weak, nonatomic) id<HDVECChatToolbarDelegate> delegate;
...
@protocol HDVECChatToolbarDelegate <NSObject>
