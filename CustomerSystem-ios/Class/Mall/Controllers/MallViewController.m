...
//            [button sd_setBackgroundImageWithURL:[NSURL URLWithString:imgUrls[button.tag]] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"imageDownloadFail.png"]];
  ...
  @{@"type":@"track", @"title":NSLocalizedString(@"em_chat_I_focus_track1", @"I focus on"), @"desc":NSLocalizedString(@"em_example1_text", @"Crackie leather bomber"), @"price":@"¥8000", @"img_url":@"http://o8ugkv090.bkt.clouddn.com/hd_one.png", @"item_url":@"http://www.easemob.com"},
  @{@"type":@"order", @"title":NSLocalizedString(@"em_chat_I_focus_order1", @"I focus on"), @"order_title":[NSString stringWithFormat:@"%@%d",NSLocalizedString(@"order_number", @"Order number:"),123], @"desc":NSLocalizedString(@"em_example3_text", @"Jeffrey campbell duice pump"), @"price":@"¥5400", @"img_url":@"http://o8ugkv090.bkt.clouddn.com/hd_three.png", @"item_url":@"http://www.lagou.com/"},
  @{@"type":@"track", @"title":NSLocalizedString(@"em_chat_I_focus_track2", @"I focus on"), @"desc":NSLocalizedString(@"em_example2_text", @"Birkin Bag"), @"price":@"¥15800", @"item_url":@"http://o8ugkv090.bkt.clouddn.com/hd_two.png",@"img_url":@"http://o8ugkv090.bkt.clouddn.com/hd_two.png"},
  @{@"type":@"order", @"title":NSLocalizedString(@"em_chat_I_focus_order2", @"I focus on"), @"order_title":[NSString stringWithFormat:@"%@%d",NSLocalizedString(@"order_number", @"Order number:"),456], @"desc":NSLocalizedString(@"em_example4_text", @"Cartier"), @"price":@"¥160000", @"img_url":@"http://o8ugkv090.bkt.clouddn.com/hd_four.png", @"item_url":@"http://www.baidu.com"}, nil];
