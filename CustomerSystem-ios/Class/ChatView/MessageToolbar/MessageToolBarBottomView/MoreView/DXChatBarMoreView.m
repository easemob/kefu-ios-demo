...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    UILabel *photoLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets, CGRectGetMaxY(_photoButton.frame), CGRectGetWidth(_photoButton.frame), 15)];
    ...
    UILabel *locationLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, CGRectGetMaxY(_locationButton.frame), CGRectGetWidth(_locationButton.frame), 15)];
    ...
    UILabel *takePicLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, CGRectGetMaxY(_takePicButton.frame), CGRectGetWidth(_takePicButton.frame), 15)];
