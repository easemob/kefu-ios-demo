...
- (void)setScaleMode:(HCallViewScaleMode)scaleMode {
    self.normalView.hScaleMode = scaleMode;
    self.deskTopView.hScaleMode = scaleMode;
}

- (HDCallRemoteView *)normalView {
    if (_normalView == nil) {
        _normalView = [[HDCallRemoteView alloc] initWithFrame:CGRectZero];
        _normalView.hScaleMode = HCallViewScaleModeAspectFill;
...
- (HDCallRemoteView *)deskTopView {
    if (_deskTopView == nil) {
        ...
        _deskTopView.hScaleMode = HCallViewScaleModeAspectFill;
