 ...
 *  Image message body
 */
@interface HImageMessageBody : HFileMessageBody
 ...
 */
@property (nonatomic)HDownloadStatus thumbnailDownloadStatus;

@property(nonatomic,strong) EMImageMessageBody *imgMessageBody;
/*!
 *  \~chinese
 *  初始化图片消息体
 *
