...
@interface HDMJRefreshAutoFooter()
@end

@implementation HDMJRefreshAutoFooter
...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (self.state != HDMJRefreshStateIdle || !self.automaticallyRefresh || self.mj_y == 0) return;
