...
@interface HDMJRefreshStateHeader()
{
...
@implementation HDMJRefreshStateHeader
...
- (void)prepare
{
    ...
    [self setTitle:NSEaseLocalizedString(@"ui.pullDownToRefresh", @"Pull To Refresh") forState:HDMJRefreshStateIdle];
    [self setTitle:NSEaseLocalizedString(@"ui.releaseToRefresh", @"Release To Refresh") forState:HDMJRefreshStatePulling];
    [self setTitle:NSEaseLocalizedString(@"ui.refreshing", @"Refreshing data") forState:HDMJRefreshStateRefreshing];
}
