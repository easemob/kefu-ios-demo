...
- (void)_setupVoiceBubbleConstraints
{
    ...
    [self.voiceImageView hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.voiceDurationLabel hdmas_updateConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.backgroundImageView.mas_top).offset(self.margin.top);
        make.bottom.equalTo(self.backgroundImageView.mas_bottom).offset(-self.margin.bottom);
    }];
    ...
    if(self.isSender){
        ...
        [self.isReadView hdmas_updateConstraints:^(MASConstraintMaker *make) {
