...
- (void)_setupTrackBubbleConstraints  {
    ...
    [self.trackTitleLabel hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.trackBgView hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.cusImageView hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.cusDescLabel hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.cusPriceLabel hdmas_updateConstraints:^(MASConstraintMaker *make) {
    ...
    [self.sendButton hdmas_updateConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.trackBgView.mas_left).offset(self.margin.left);
