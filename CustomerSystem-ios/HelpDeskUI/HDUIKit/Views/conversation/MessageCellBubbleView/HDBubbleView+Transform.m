...
- (void)_setupTransformBubbleMarginConstraints {
    ...
    NSLayoutConstraint *transTitleMarginTopConstraint = [NSLayoutConstraint constraintWithItem:self.transTitle attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeTop multiplier:1.0 constant:self.margin.right];
    NSLayoutConstraint *transTitleMarginLeftConstraint = [NSLayoutConstraint constraintWithItem:self.transTitle attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:self.margin.right];
...
//    NSLayoutConstraint *transButtonMarginTopConstraint = [NSLayoutConstraint constraintWithItem:self.transformButton attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.transTitle attribute:NSLayoutAttributeBottom multiplier:1.0 constant:0];
    NSLayoutConstraint *transButtonMarginBottomConstraint = [NSLayoutConstraint constraintWithItem:self.transformButton attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:-self.margin.right];
    NSLayoutConstraint *transButtonMarginLeftConstraint = [NSLayoutConstraint constraintWithItem:self.transformButton attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:self.margin.right];
    NSLayoutConstraint *transButtonMarginRightConstraint = [NSLayoutConstraint constraintWithItem:self.transformButton attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeRight multiplier:1.0 constant:-self.margin.right];
...
- (void)setupTransformBubbleView {
    ...
    self.transformButton.titleLabel.font = [UIFont systemFontOfSize:17.0];
...
- (void)setTransformButtonBackgroundColorWithEnable:(BOOL)enable {
    self.transformButton.backgroundColor = enable?RGBACOLOR(242, 94, 91, 1):[UIColor lightGrayColor];
