...
#import "HDVECSatisfactionEvaluationTagView.h"
...
@protocol HDVECSatisfactionDelegate <NSObject>
...
@interface HDVECSatisfactionView : UIView
typedef void(^HDVECUpdateSelfFrame)(CGFloat height);
@property (nonatomic, strong) id<HDIMessageModel> messageModel;
@property (nonatomic, weak) id<HDVECSatisfactionDelegate> delegate;

@property (nonatomic,copy) void(^EvaluateSuccessBlock)();
@property (nonatomic,copy) HDVECUpdateSelfFrame updateSelfFrame;
...
@property (nonatomic, strong) HDVECSKTagView *evaluationTagView;
