...
@interface HDVECControlBarView ()<UIPopoverPresentationControllerDelegate>{
...
//                    [self hd_setButton:button withBackground:HDControlBarButtonBackgroundRed withSize:button.width*0.9 withImageName:model.imageStr withSelectImage:model.selImageStr];
                ...
                UIImage *imgSel  = [UIImage imageWithIcon2:model.imageStr inFont:kfontName size:button.hd_width*0.8 color:[[HDVECAppSkin mainSkin] contentColorRed] withbackgroundColor:[[HDVECAppSkin mainSkin] contentColorWhitealpha:1]  ] ;
...
//
                [button setImage:[UIImage imageWithIcon:model.imageStr inFont:kfontName size:button.hd_width/2.5 color:[[HDVECAppSkin mainSkin] contentColorBlue] ] forState:UIControlStateNormal];
